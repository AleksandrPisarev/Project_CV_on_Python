...
# программа считывает видеопоток с веб-камеры если обнаруживает лица обводит их прямоугольником
# При нажатии на пробел записывает кадр в файл video.jpg
...
while(True):
    ...
    if not ret:
        ...
        break
    result_img,face_boxes=highlightFace(faceNet,im)
    if not face_boxes:
        print("лиц на экране нет")
